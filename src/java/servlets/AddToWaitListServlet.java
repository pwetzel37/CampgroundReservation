...
@WebServlet(name = "AddToWaitListServlet", urlPatterns = {"/AddToWaitListServlet"})
public class AddToWaitListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String customerName = request.getParameter("select_customer");
        ...
        WaitingList waitingList = new WaitingList (customerId, nights, sites, notes,
        requestDate, arrivalDate, departureDate, priority);
        
        WaitingListManager wm = database.Database.getDatabaseManagement().getWaitingListManager();
        WaitingList added = wm.addWaitingList(waitingList);
