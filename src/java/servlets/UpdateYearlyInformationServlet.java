 ...
 */
@WebServlet(name = "UpdateYearlyInformationServlet", urlPatterns = {"/UpdateYearlyInformationServlet"})

public class UpdateYearlyInformationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        YearlyInformation updated = ym.updateYearlyInformation(yearlyInformation);
