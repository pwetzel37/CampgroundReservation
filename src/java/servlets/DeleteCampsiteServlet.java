...
/**
 * Delete the selected Campsite from the database and returns to the Campsite
 * table
 *
 * @author Michael Boyd (2021)
 */
@WebServlet(name = "DeleteCampsiteServlet", urlPatterns = {"/DeleteCampsiteServlet"})
public class DeleteCampsiteServlet extends HttpServlet {
