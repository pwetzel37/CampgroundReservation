    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(email == null) {
            ...
            RequestDispatcher requestDispatcher =  
              getServletContext().getRequestDispatcher("/jsp/ForgotPassword.jsp");
        ...
        if(userList != null && userList.size() > 0)  {
            ...
            while(it.hasNext()){
                ...
                message += protocol+"://"+request.getServerName()+":"+portNumber+
                        "/OutsideLoginsOnlyTemplate/ControlServlet?control=resetpassword&" 
